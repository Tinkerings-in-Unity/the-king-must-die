...
namespace Opsive.UltimateCharacterController.Objects
{
    ...
    public class TrajectoryObject : MonoBehaviour, IForceObject, IDamageSource, ISmoothedObject
    {
        ...
        [SerializeField] protected float m_SettleThreshold = 0.01f;
        ...
        public float SettleThreshold { get { return m_SettleThreshold; } set { m_SettleThreshold = Mathf.Max(value, 0.001f); } }
        ...
        protected virtual void Awake()
        {
            ...
            if (m_SettleThreshold <= 0) {
                m_SettleThreshold = 0.001f;
            }
