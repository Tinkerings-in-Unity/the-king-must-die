    ...
    public class NavMeshAgentMovement : PathfindingMovement
    {
        ...
        public override void ApplyPosition()
        {
            if (m_NavMeshAgent.remainingDistance <= m_CharacterLocomotion.DesiredMovement.magnitude) {
                ...
                var direction = m_CharacterLocomotion.InverseTransformPoint(m_NavMeshAgent.destination);
                var desiredMovement = m_CharacterLocomotion.InverseTransformDirection(m_CharacterLocomotion.DesiredMovement);
